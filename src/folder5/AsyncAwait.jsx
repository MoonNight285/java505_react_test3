...
function AsyncAwait(props) {
    ...
    const getData = async () => {
        const {data} = await axios.get("https://kobis.or.kr/kobisopenapi/webservice/rest/boxoffice/searchDailyBoxOfficeList.json?key=f5eef3421c602c6cb7ea224104795888&targetDt=20221230");
        console.log(data);
    }
