...
function AxiosRestServer(props) {
    ...
    const sendDataPost = () => {
        axios.post("http://localhost:8080/async/sendDataPost", null, {params : {id : "id", pw : "pw"}})
            ...
            .catch(err => {
                console.log("post 통신 오류");
            });
    };
    
    const sendDataPut = () => {
        axios.put("http://localhost:8080/async/sendDataUpdate", null, {params : {idx : 100}})
            .then(req => {
                console.log("put!");
                console.log(req);
            })
            .catch(err => {
                console.log("put 통신 오류");
            });
    };
    
    const sendDataDelete = () => {
        axios.delete("http://localhost:8080/async/sendDataDelete", {params : {idx : 100}})
            .then(req => {
                console.log("delete!");
                console.log(req);
            })
            .catch(err => {
                console.log("delete 통신 오류");
            });
    };
