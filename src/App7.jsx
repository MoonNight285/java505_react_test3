...
function App7(props) {
    return (
        ...
        // 사용법 : 기존 url 뒤에 /와 :파라미터명을 사용하여 데이터를 전달하는 방식이다.
        // rest 방식에서 많이 사용한다.
        ...
        // 지정된 컴포넌트에서 몇가지 옵션 사항을 사용할 수 있다.
        // 옵션
        ...
        // useLocation() 훅을 사용하여 데이터를 가져오면 원하는 파라미터 값을 가져오기 위해 직접 파싱을 진행해야 한다.
        // useSearchParams() 훅을 사용하여 데이터를 가져오면 파라미터 데이터만 따로 가져올 수 있다.
        // 사용법
        // 기존 url?파라미터=값1&파라미터2=값2
        
        // useNavigate() : Link 컴포넌트를 사용하지 않고 다른 페이지로 이동하는 훅
        // 사용법 
        // const navigate = useNavigate();
        // navigate(-1) => History를 사용하여 이전 페이지로 이동, 숫자를 음수로 입력 시 해당 뒤로 이동하고,
        // 양수를 일력시 앞으로 이동한다.
        // navigate('/url') => 지정한 url로 이동한다.
